...
$o=new DOAPOntology("http://git.eigenlab.org/ontology/");
$o->addLicense('http://creativecommons.org/licenses/by/4.0/');
$p=GitlabProjectsParser::getFromRESTEndpoint("https://git.eigenlab.org/api/v4/projects/","https://www.mittelab.org/projects/");
foreach ($p as $entry){
	$o->add($entry);
}
